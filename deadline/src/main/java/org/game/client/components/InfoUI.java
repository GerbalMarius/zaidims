...
public class InfoUI {
    ...
    public void render(Graphics2D g2, int screenWidth, int screenHeight,
        ...
        while (playerIterator.hasNext()) {
            ...
            // Use the actual current max health, not a static value
            ...
            // Clamp health percentage to 1.0 max to prevent overflow
            float healthPercent = Math.min(1.0f, (float) currentHP / maxHP);
            g2.setColor(healthPercent > 0.5f ? Color.GREEN : Color.RED);
